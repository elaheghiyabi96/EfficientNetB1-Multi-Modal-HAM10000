# -*- coding: utf-8 -*-
"""EfficientNetB1_metadata_74.64%.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B09lFQ9hKNBxoUUtOeQezQkpUYnTXGkq
"""
...
print("\nStarting multi-modal model training with EfficientNetB1...")
history = model.fit(
    train_dataset,
    epochs=EPOCHS,
...
print("\n" + "="*40)
print("     Final Results on the Validation Set (Multi-modal EfficientNetB1)")
print("="*40)
...
plt.title('Confusion Matrix for Multi-Modal EfficientNetB1')
plt.show()